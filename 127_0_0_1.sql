...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2025 at 11:57 AM
...
-- Database: `atmbaza`
--
CREATE DATABASE IF NOT EXISTS `atmbaza` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `atmbaza`;
...
INSERT INTO `users` (`id`, `username`, `pin`, `balance`, `role`) VALUES
...
('root', '[{\"db\":\"atmbaza\",\"table\":\"users\"},{\"db\":\"testuje\",\"table\":\"person\"}]');
...
('root', '2025-04-28 09:56:37', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pl\"}');
...
-- Database: `testuje`
--
CREATE DATABASE IF NOT EXISTS `testuje` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `testuje`;
